...
| `nvidia/canary-qwen-2.5b` | 2.5B | NVIDIA NeMo Team | CC-BY-4.0 | https://huggingface.co/nvidia/canary-qwen-2.5b | *"Canary-Qwen-2.5B by NVIDIA, licensed under CC-BY-4.0. Source: https://huggingface.co/nvidia/canary-qwen-2.5b"* Loaded by `src/extraction/flow/variant_b/pipeline.py` as the Variant B ASR stage. Admitted under the 2026-04-21 CC-BY-4.0 ADR (accepted by user directive 2026-04-23). |
| `pyannote/speaker-diarization-3.1` | 3.1 | Hervé Bredin, pyannote.audio | CC-BY-4.0 | https://huggingface.co/pyannote/speaker-diarization-3.1 | *"pyannote/speaker-diarization-3.1 by Hervé Bredin (pyannote.audio), licensed under CC-BY-4.0. Source: https://huggingface.co/pyannote/speaker-diarization-3.1"* Loaded by `src/extraction/flow/variant_b/pipeline.py` as the Variant B diarisation stage (held constant vs Variant A so ASR choice is the only variable). Admitted under the same 2026-04-21 CC-BY-4.0 ADR. |
